...
* Informations über den Browsertyp und die verwendete Version
...
Soweit Sie sich auf unserer Plattform registrieren, ein Kundenkonto anlegen oder Bestellungen über unsere Bestellformulare (WaaS-Tarife) aufgeben, verarbeiten wir die dafür erforderlichen Daten:

* Registrierungsdaten (E-Mail-Adresse, Passwort-Hash, Name)
* Vertragsdaten (Tarifwahl, Startdatum, Rechnungsadresse)
* Zahlungsdaten (SEPA-Lastschriftmandat, Bankverbindung)
...
Zudem bedienen wir uns angemessener technischer und organisatorischer Sicherheitsmaßnahmen, um Ihre Daten gegen zufällige oder vorsätzliche Manipulationen, teilweisen oder vollständigen Verlust, Zerstörung oder gegen den unbefugten Zugriff Dritter zu schützen.
