...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: locale === "de" ? "SEPA-Lastschriftmandat" : locale === "es" ? "Mandato de Débito Directo SEPA" : "SEPA Direct Debit Mandate",
    alternates: {
      canonical: `/${locale}/sepa-mandat`,
    },
  };
}

export default function SepaMandatPage() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground font-sans pt-40 pb-32 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/3 w-[80vw] h-[80vw] max-w-[800px] max-h-[800px] rounded-full blur-[120px] bg-[radial-gradient(circle,rgba(204,255,0,0.05)_0%,rgba(0,0,0,0)_70%)] pointer-events-none -z-10" />
