  ...
  return (
    <main className="min-h-screen bg-transparent text-foreground font-sans pt-16">
      ...
      <GrowthHero
        ...
        description={`Websites auf Autopilot: Rundum-Sorglos statt teurer Einmalzahlung. Wir gestalten, hosten und pflegen deine neue Homepage direkt hier vor Ort in Chemnitz ab ${basePlan.priceMonthly}€ im Monat. Damit du dich als Macher voll auf dein Geschäft konzentrieren kannst.`}
      />
      <RealityCheckSection />
      <BlueprintFlow />
