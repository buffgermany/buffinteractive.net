  ...
  return (
    <main className="min-h-screen bg-transparent text-foreground font-sans pt-16">
      ...
      <GrowthHero
        ...
        description={`Rundum-Sorglos statt teurer Einmalzahlung. Wir gestalten, hosten und pflegen deine neue Homepage direkt hier vor Ort in Chemnitz ab ${basePlan.priceMonthly}€ im Monat. Keine Kopfschmerzen, kein Wartungsstress – damit du dich voll auf dein Geschäft konzentrieren kannst.`}
      />
      <RealityCheckSection />
      <BlueprintFlow />
