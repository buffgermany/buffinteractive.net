  ...
  return (
    <main className="min-h-screen bg-transparent text-foreground font-sans pt-16">
      ...
      <GrowthHero
        ...
        description={`Rundum-Sorglos statt teurer Einmalzahlung oder unvorhergesehenen Wartungskosten. Wir gestalten, hosten und pflegen deine neue Homepage direkt hier vor Ort in Leipzig ab ${basePlan.priceMonthly}€ im Monat. Damit du dich voll auf dein Geschäft konzentrieren kannst.`}
      />
      <RealityCheckSection />
      <BlueprintFlow />
