...
export function GrowthParadigmCheckout({
  inviteTarif,
  onSelectPlan
}: {
  inviteTarif: string;
  onSelectPlan: (tarif: string, zahlungsrhythmus: string) => void;
}) {
        ...
        <div className="hidden xl:flex sticky top-0 h-dvh flex-col justify-center items-center overflow-hidden py-6 px-6">
          ...
          >
            ...
            <div className="relative w-[310px] lg:w-[350px] xl:w-[380px] h-[610px] lg:h-[650px] xl:h-[695px] flex items-center justify-center z-10">
                ...
                <MagneticCard>
                  ...
                  >
                    <PricingCardContent
                      ...
                      onCtaClick={(e) => { e.preventDefault(); onSelectPlan("essential", billingInterval); }}
                    />
                  </BentoCard>
                </MagneticCard>
              </motion.div>
              ...
              {["essential", "growth"].includes(inviteTarif) && (
                <motion.div
                  style={{
                    x: "0%",
                    rotate: 0,
                ...
                <MagneticCard>
                  ...
                  >
                    <PricingCardContent
                      ...
                      cta={inviteTarif === "growth" ? "Diesen Tarif wählen" : "Auf Growth upgraden"}
                      isPopular={true}
                      onCtaClick={(e) => { e.preventDefault(); onSelectPlan("growth", billingInterval); }}
                    />
                  </BentoCard>
                </MagneticCard>
              </motion.div>
                ...
                <MagneticCard>
                  ...
                  >
                    <PricingCardContent
                      ...
                      onCtaClick={(e) => { e.preventDefault(); window.location.href = "mailto:service@buffinteractive.net?subject=Enterprise%20Angebot"; }}
                    />
                  </BentoCard>
                </MagneticCard>
              </motion.div>
