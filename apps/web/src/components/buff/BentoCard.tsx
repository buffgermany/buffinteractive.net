...
export function BentoCard({
  ...
  return (
    <motion.div
      ...
      className={`relative group rounded-3xl bg-[#2C2C2C]/20 border border-white/5 overflow-hidden will-change-transform ${withGlassmorphism ? "backdrop-blur-xl" : ""
        } ${className}`}
    >
      <motion.div
      ...
      />
      <div
        className="relative z-10 w-full h-full p-4 xs:p-6 lg:p-8 flex flex-col justify-between"
