...
function Word({ token, index, total, progress }: WordProps) {
  ...
  return (
    <motion.span
      ...
      className="font-heading font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl 2xl:text-[3.5rem] text-center"
    >
      {token.text}
    </motion.span>
  );
...
export function RealityCheckSection() {
  const text: string = "Eine veraltete Website, die auf Handys schlecht aussieht, oder gar keine eigene Präsenz im Netz kostet dich täglich wertvolle Kunden. Wer heute online nicht professionell gefunden wird, existiert für viele Menschen gar nicht.";
  const highlightPhrase: string = "kostet dich täglich wertvolle Kunden";
    ...
    >
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
        ...
        >
           ...
           */}
          <p className="font-heading font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl 2xl:text-[3.5rem] leading-normal">
